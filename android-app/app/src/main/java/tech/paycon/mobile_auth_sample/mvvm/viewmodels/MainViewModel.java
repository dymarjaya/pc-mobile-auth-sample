...
public class MainViewModel extends ViewModel {
    ...
    public void submitAliasAndActivationCode(@Nullable String alias, @Nullable String activationCode) {
        ...
        new Thread(() -> {
            ...
            Response response = performPlainRequest(Constants.URL_TO_WEBAPP_BACKEND + "/pers/alias/get_pc_user", body);
    ...
    public void authenticate() {
        ...
        new Thread(() -> {
            ...
            Response response = performPlainRequest(Constants.URL_TO_WEBAPP_BACKEND + "/auth/start_authentication", body);
            if (response == null || response.code != 200) {
        ...
        PCTransactionsManager.sign(mUser, transaction, new PCSignCallback() {
            ...
            public void success() {
                ...
                new Thread(() -> {
                    ...
                    String body = "{\"pc_user_id\":\"" + mUser.getUserId() + "\"}";
                    Response response = performPlainRequest(Constants.URL_TO_WEBAPP_BACKEND + "/auth/finish_authentication", body);
                    if (response == null || response.code != 200) {
